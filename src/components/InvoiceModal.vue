            ...
            <div class="invoice-work flex flex-column">
                <div class="payment flex">
                    ...
                    <div class="input flex flex-column">
                        ...
                        <input disable type="text" id="paymentDueDate" v-model="paymentDueDate">
                    </div>
                </div>
                <div class="input flex flex-column">
                ...
                <div class="work-items">
                    ...
                    <table class="item-list">
                        ...
                        <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
                            ...
                            <img @click="deleteInvoiceItems(item.id)" src="@/assets/icon-delete.svg" alt="" />
                        </tr>
                    </table>
...
export default {
    ...
    methods: {
        ...
        async updateInvoice() {
            if (this.invoiceItemList.length <= 0) {
                alert('Please ensure you filled out all fields!');
                return;
            }
            ...
            this.calInvoiceTotal();
            const invoiceDocRef = doc(db, 'invoices', this.docId);
            ...
            this.UPDATE_INVOICE({ docId: this.docId });
        },
